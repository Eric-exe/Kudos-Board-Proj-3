                        ...
                        <div className="modal-body">
                            ...
                            <div className="row mt-2 align-items-center">
                                ...
                                <div className="col-9">
                                    <input
                                        ...
                                        className="form-control"
                                        id="gifphySearchBar"
                                        onChange={handleSearchGIFChange}
                                    ></input>
                                </div>
                            </div>
                                    ...
                                    GIFsData["data"].map((gif, index) => {
                                        return (
                                            <img
                                                ...
                                                onClick={(event) => setGIFUrl(event.target.src)}
                                            />
                                        );
                                    })
                                )}
                            ...
                            <div className="form-check form-switch mt-2">
                                <input
                                    ...
                                    type="checkbox"
                                    id="signToggle"
                                    onChange={(event) => setCardSigned(event.target.checked)}
                                />
                                <label className="form-check-label" htmlFor="signToggle">
                                    Sign Card
                                </label>
                            </div>
                        </div>
